      ...
      questions: [
        {
          ...
          desc: 'Все фасады сделаны из <span>влагостойкого</span> ЛДСП Немецкой фирмы EGGER <br>Корпуса выполнены из <span>надежного</span> ЛДСП Австрийской фирмы Kronospan'
        },
        {
