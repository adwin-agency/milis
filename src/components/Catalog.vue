    ...
    return {
      ...
      questions: [
        ...
        },
        {
          ...
          desc: 'Дизайнер Milis приедет к вам, сделает замеры и составит 3D проект. Подготовит дизайн-проект кухни, а также предоставит образцы материалов. Выезд специалиста будет абсолютно бесплатным'
        },
        {
          title: 'Что включено в покупку кухни?',
          desc: 'Все кухни производятся на заказ "под ключ": замер дизайнера, 3D проект кухни, производство, доставка и сборка. У нас вы сможете сразу приобрести бытовую технику под ваши размеры'
        },
        {
