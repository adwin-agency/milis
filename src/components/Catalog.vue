...
export default {
  ...
  data() {
    return {
      questions: [
        {title: 'Почему наши кухни дешевле, чем у конкурентов?', desc: 'Собственное производство позволяет снизить себестоимость кухни без потери в качестве. У нас нет салонов в привычном понимании - только онлайн. Это позволяет сэкономить на аренде магазинов и прочих затратных атрибутах оффлайн магазинов.'},        
        {title: 'Насколько хорошее качество кухни?', desc: 'Фасады изготавливаются из МДФ производства фирмы EGGER, которая хорошо зарекомендовала себя на рынке за счет высокой прочности материалов. Корпуса выполнены из ЛДСП фирмы Kronospan - ещё одного флагмана кухонной индустрии.'},        
        {title: 'Как заказать кухню?', desc: 'Вам никуда не нужно ехать. Мы сами приедем к вам. С собой наш специалист возьмет образцы материалов, чтобы вы получили полное представление о том, какой будет ваша будущая кухня. При этом, выезд дизайнера будет бесплатным даже в том случае, если вы решите повременить с покупкой.'},
